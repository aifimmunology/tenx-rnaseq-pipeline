...
#### [ADT well QC: run_adt_well_qc.R](#adt_qc)
- [Barcounter Requirements](#adt_barcounter_req)
- [Parameters](#adt_qc_param)
  - [Tag Counts](#adt_qc_tc)
  - [Barcodes](#adt_qc_bc)
- [Outputs](#adt_qc_out)

#### [ADT matrix injection: run_adt_injection.R](#inj)
- [Parameters](#inj_param)
- [Outputs](#inj_out)
...
Note that the whitelist supplied to the QC Analysis in the next step is a [different file](#adt_qc_bc).
